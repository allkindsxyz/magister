...
const en: GamesCopy = {
  ...
  learn: {
    ...
    board_ready: 'All 52 cards read true.',
    board_need: 'To reach the record, name all 52 cards within five minutes.',
...
const ru: GamesCopy = {
  ...
  learn: {
    ...
    board_ready: 'Все 52 карты угаданы.',
    board_need: 'Чтобы попасть в запись, угадайте все 52 карты за пять минут.',
...
const zh: GamesCopy = {
  ...
  learn: {
    ...
    board_ready: '已猜中全部 52 张。',
    board_need: '要进入记录，需在五分钟内猜中全部 52 张。',
    place_kicker: '编年中的名次',
    place_no: '第{place}',
    place_of: '共 {total}',
    chronicle: '把名字写入编年',
